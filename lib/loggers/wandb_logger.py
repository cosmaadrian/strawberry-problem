...
class WandbLogger(object):
    def __init__(self):
        ...
        self.cummulative_metrics = defaultdict(lambda: 0)
    ...
    def log(self, key, value, on_step = True, force_log = False, log_min = False, log_max = False, log_instant = True, cummulative = False):
        if cummulative:
            self.cummulative_metrics[key] += value
            value = self.cummulative_metrics[key]
